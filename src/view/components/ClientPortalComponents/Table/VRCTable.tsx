...
export default function VRCTable() {
            ...
            <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
                <TableHead>
                    <StyledTableRow>
                        ...
                        <StyledTableCell>PSV Completed Date</StyledTableCell>
                        <StyledTableCell>Review Level</StyledTableCell>
                        <StyledTableCell>Recred Due Date</StyledTableCell>
                        <StyledTableCell>Review Date</StyledTableCell>
                        <StyledTableCell>Committee Date</StyledTableCell>
                    ...
                    {(rowsPerPage > 0 ? rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage) : rows).map(
                        (row) => (
                            <StyledTableRow key={row.practitionerName}>
                                <StyledTableCell>Unassigned</StyledTableCell>
                                <StyledTableCell component="th" scope="row">
                                    {row.practitionerName}
                                </StyledTableCell>
                                <StyledTableCell>MD</StyledTableCell>
                                <StyledTableCell>Recred</StyledTableCell>
                                <StyledTableCell>11/17/2022</StyledTableCell>
                                <StyledTableCell>Non-Expedited</StyledTableCell>
                                <StyledTableCell>11/30/2022</StyledTableCell>
