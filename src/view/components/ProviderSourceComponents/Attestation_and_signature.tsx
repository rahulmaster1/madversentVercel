        ...
        <React.Fragment>
            <form onSubmit={handleSubmit(onSubmit)} onSelect={() => autoSave()}>
                <Grid item sx={{ mb: '20px', mt: '50px' }}>
                    The following application form(s) need(s) to be filled. Click on the form link to go back to the
                    form and populate the required fields as indicated on the form:
                </Grid>
