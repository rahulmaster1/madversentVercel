...
import { ApptrackerPages } from 'config/apptrackerSubPage';
...
const ApptrackerLayout: FC<{ children: ReactNode }> = ({ children }) => {
    ...
    return (
        <section id="provider_source">
            ...
            >
                ...
                >
                    {ApptrackerPages.map((page, index) => {
                        return (
                            <Tab
                                value={page.href}
                                key={page.title}
...
export default ApptrackerLayout;
