...
export default function ClientHomeTable() {
            ...
            <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
                <TableHead>
                    <StyledTableRow>
                        ...
                        <StyledTableCell>Ready for Download</StyledTableCell>
                        <StyledTableCell>In Process</StyledTableCell>
                        <StyledTableCell>Submitted</StyledTableCell>
                        <StyledTableCell>Incomplete Application</StyledTableCell>
                        <StyledTableCell>Appkication Not Received</StyledTableCell>
