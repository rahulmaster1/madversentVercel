...
const options = ['QUERY FACILITY REPORT', 'Show FacilitySHOW FACILITY	'];
        ...
        <div style={{ margin: '20px 0' }}>
            <ButtonGroup variant="contained" ref={anchorRef} aria-label="split button">
                ...
                <Button
                    ...
                    href={
                        selectedIndex == 0
                            ? '/apptracker/manage_facility/ShowFACILITYTablePage'
                            : selectedIndex == 1
                            ? '/apptracker/manage_facility/ShowFACILITYTableInTablePage'
                            : ''
                    }
