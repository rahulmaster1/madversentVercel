...
const options = ['QUERY PROVIDER REPORT', 'Show ProviderSHOW PROVIDER'];
        ...
        <div style={{ margin: '20px 0' }}>
            <ButtonGroup variant="contained" ref={anchorRef} aria-label="split button">
                ...
                <Button
                    ...
                    href={
                        selectedIndex == 0
                            ? '/apptracker/manage_provider/ShowPROVIDERTablePage'
                            : selectedIndex == 1
                            ? '/apptracker/manage_provider/ShowPROVIDERTableInTablePage'
                            : ''
                    }
